...
import br.com.crudjava.infra.ConnectionFactory;
...
import java.util.Optional;
    ...
    public class DespesaDAO implements IDespesaDAO {
        @Override
        public Despesa save(Despesa despesa) {//INSERIR DESPESAS
        ...
        @Override
        public Despesa update(Despesa despesa) {//ATUALIZAR DESPESAS
            try (Connection connection = ConnectionFactory.getConnection()) {
        ...
        @Override
        public void delete(Long id) {//REMOVER DESPESA
            try (Connection connection = ConnectionFactory.getConnection()) {
        ...
        @Override
        public List<Despesa> findAll() {//meotodo de busca para despesa
        ...
        @Override
        public Optional<Despesa> findById(Long id) {//METODO DE BUSCA PARA ID
        ...
        @Override
        public List<Despesa> findByCategoria(Categoria categoria) {//METODO DE BUSCA PARA CATEGORIA
